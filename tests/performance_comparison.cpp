...
int main() {
    std::cout << "Performance Comparison: Single Character vs Character Class\n";
    std::cout << "==========================================================\n\n";
    ...
    if (results_consistent) {
        ...
        if (a_class_avg < 2.0) {
            std::cout << "✅ Character class patterns are using SIMD (very fast: " << a_class_avg << " ns)\n";
        } else {
            std::cout << "❌ Character class patterns are NOT using SIMD (slow: " << a_class_avg << " ns)\n";
        }
        
        if (a_star_avg < 2.0) {
            std::cout << "✅ Single character patterns are using SIMD (very fast: " << a_star_avg << " ns)\n";
        } else {
            std::cout << "❌ Single character patterns are NOT using SIMD (slow: " << a_star_avg << " ns)\n";
        }
